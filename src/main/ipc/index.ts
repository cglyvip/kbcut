...
import {
  getWhisperModelCacheDir,
  getWhisperModelInfo,
} from "../services/asr-model";
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle(
    "test-llm-providers",
    async (_event, providers: LlmProvider[]) => {
  ...
  ipcMain.handle(
    ...
    async (_event, taskId: string, payload: any) => {
