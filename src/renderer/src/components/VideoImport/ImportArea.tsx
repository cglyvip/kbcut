...
export default function ImportArea() {
        ...
        <div style={styles.infoBar}>
          ...
          <div style={styles.infoMain}>
            ...
            <span style={styles.infoMeta}>
              {formatDuration(videoInfo.duration)} | {videoInfo.width}x{videoInfo.height} | {videoInfo.fps}FPS | {formatFileSize(videoInfo.fileSize)} | {videoInfo.codec}
            </span>
          </div>
  ...
  return (
    <div style={styles.container}>
      <div
        style={{ ...styles.importBox, ...(dragOver ? styles.importBoxDragOver : {}) }}
      ...
      >
        <div style={styles.iconWrap}>
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#bfbfbf" strokeWidth="1.5">
