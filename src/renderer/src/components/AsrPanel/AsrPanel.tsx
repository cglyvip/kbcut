    ...
    <div style={styles.container}>
      <div style={styles.settingsCard}>
        ...
        <div style={styles.modeRow}>
          ...
          <button
            style={
              settings.mode === "local" ? styles.modeActive : styles.modeBtn
            }
        ...
        {settings.mode === "local" && (
          <p style={styles.hint}>
            本地 Whisper 模型，首次会下载模型，无需 API Key。
          </p>
        )}
        ...
        <button
          style={{
            ...styles.startBtn,
            ...(loading || !videoInfo ? styles.btnDisabled : {}),
          }}
        ...
        {segments.length > 0 && (
          <div style={styles.stats}>
            <span>
              共 {segments.length} 句 / {includedWordCount} 词 /{" "}
            ...
            {segments.map((seg, i) => (
              <div key={i} style={styles.segItem}>
                <div style={styles.segHeader}>
                  ...
                  <span style={styles.segDur}>
                    {(seg.end - seg.start).toFixed(1)}s
                  </span>
                  <button
                    style={styles.miniBtn}
                    onClick={() => excludeAllInSegment(i)}
                  >
                    整句排除
                  </button>
                  <button
                    style={styles.miniBtn}
                    onClick={() => includeAllInSegment(i)}
                  >
                    整句恢复
                  </button>
                </div>
