...
interface LlmTabProps {
  ...
  testingAll: boolean
  onTestProvider: (provider: ReturnType<typeof useLlmStore.getState>['providers'][number]) => void
  onTestAll: () => void
  setMsg: (msg: string | null) => void
  setErr: (err: string | null) => void
}

export default function LlmTab({ testingId, testingAll, onTestProvider, onTestAll }: LlmTabProps) {
  const {
    providers,
    updateProvider,
    addProvider,
  ...
  return (
    <div>
        ...
        {providers.map((p, idx) => (
          <div key={p.id} style={styles.providerCard}>
            ...
            <div style={styles.actions}>
              <button style={styles.miniBtn} onClick={() => onTestProvider(p)} disabled={!!testingId || testingAll}>
      ...
      <div style={styles.actions}>
        ...
        <button style={styles.miniBtn} onClick={onTestAll} disabled={testingAll || !!testingId}>
